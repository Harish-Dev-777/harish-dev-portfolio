...
export const ContactSection = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Sanitize data before arbitrary usage/sending
    const sanitizedData = {
    ...
    console.log("Sanitized Form Data Submitted:", sanitizedData);
  ...
  return (
    <>
      <section id="contact" className="w-full min-h-screen bg-background flex items-center py-20 pl-24 pr-6 md:pl-[12vw] md:pr-12 lg:pl-[15vw] lg:pr-24">
          ...
          <form onSubmit={handleSubmit} className="w-full">
            ...
            <div className="text-2xl sm:text-3xl md:text-4xl lg:text-[2.75rem] leading-[2.2] md:leading-[2] font-poppins font-light text-foreground/80">
              ...
              <input
                ...
                required
                className="bg-transparent border-b border-foreground/20 px-2 py-1 mx-1 text-foreground placeholder:text-foreground/30 focus:outline-none focus:border-foreground transition-colors w-[220px] md:w-[350px]"
              />
              ...
              />
              <span className="text-sm md:text-base text-foreground/40 align-baseline ml-1">(optional)</span>
              ...
              <div className="inline-block relative">
                ...
                <div 
                  ...
                  className="bg-transparent border-b border-foreground/20 px-2 pr-8 py-1 mx-1 focus:outline-none focus:border-foreground transition-colors w-[220px] md:w-[300px] cursor-pointer relative flex items-center"
                >
                  <span className={cn("block truncate", formData.service ? "text-foreground" : "text-foreground/30")}>
                        ...
                        {SERVICES.map((service) => (
                          <button
                            ...
                            className={cn(
                              ...
                              formData.service === service && "bg-foreground/5 text-foreground font-medium"
                            )}
                          >
                            {service}
                          </button>
              ...
              <input
                ...
                required
                className="bg-transparent border-b border-foreground/20 px-2 py-1 mx-1 text-foreground placeholder:text-foreground/30 focus:outline-none focus:border-foreground transition-colors w-[250px] md:w-[380px]"
              />
              ...
              <input
                ...
                required
                className="bg-transparent border-b border-foreground/20 px-2 py-1 mx-1 text-foreground placeholder:text-foreground/30 focus:outline-none focus:border-foreground transition-colors w-[220px] md:w-[300px]"
              />
            ...
            <div className="mt-16 sm:mt-24">
              <motion.button
                ...
                className={cn(
                  ...
                  isSubmitting ? "bg-orange-500 text-white cursor-wait" : "bg-foreground text-background hover:bg-foreground/90 hover:shadow-xl dark:hover:shadow-orange-500/20"
                )}
              >
                ...
                <motion.div 
                  className={cn(
                    ...
                    isSubmitting ? "bg-white/20 text-white" : "bg-background text-foreground"
                  )}
                >
                  {isSubmitting ? (
                    <motion.div 
        ...
        {isSubmitted && (
          ...
          >
            ...
            >
              ...
              >
                Your transmission has been received. I'll drop into your inbox shortly.
              </motion.p>
